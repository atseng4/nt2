...
namespace boost { namespace simd { namespace ext
{
  ...
  template<std::size_t N> struct vmx_permute
  {
                                    ...
                                    )
    {
      ...
      __vector char mask =  { char(details::zero_mask<s_t,P, 0,N>::value)
                            , char(details::zero_mask<s_t,P, 1,N>::value)
                            , char(details::zero_mask<s_t,P, 2,N>::value)
                            , char(details::zero_mask<s_t,P, 3,N>::value)
                            , char(details::zero_mask<s_t,P, 4,N>::value)
                            , char(details::zero_mask<s_t,P, 5,N>::value)
                            , char(details::zero_mask<s_t,P, 6,N>::value)
                            , char(details::zero_mask<s_t,P, 7,N>::value)
                            , char(details::zero_mask<s_t,P, 8,N>::value)
                            , char(details::zero_mask<s_t,P, 9,N>::value)
                            , char(details::zero_mask<s_t,P,10,N>::value)
                            , char(details::zero_mask<s_t,P,11,N>::value)
                            , char(details::zero_mask<s_t,P,12,N>::value)
                            , char(details::zero_mask<s_t,P,13,N>::value)
                            , char(details::zero_mask<s_t,P,14,N>::value)
                            , char(details::zero_mask<s_t,P,15,N>::value)
                            };
